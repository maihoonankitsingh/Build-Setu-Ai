...
function BbsPage({ theme }: { theme: ResolvedTheme }) {
  ...
  const diameterUsageSummary = useMemo(() => {
    const colorPalette = ["#6d35ff", "#5d9cff", "#63d99c", "#ffac45", "#ff6f91", "#8b5cf6"];
  ...
  return (
    <div className="mx-auto max-w-[1500px] overflow-x-hidden space-y-5 px-1 pb-8">
      ...
      <div className="grid min-w-0 items-start gap-5 xl:grid-cols-[minmax(0,7fr)_minmax(360px,3fr)] 2xl:grid-cols-[minmax(0,7fr)_minmax(400px,3fr)]">
      ...
      <div className="grid h-[78px] w-[78px] place-items-center rounded-full bg-white shadow-inner">
                ...
                <div className="min-w-0 space-y-2">
                  {diameterUsageSummary.length ? (
                    diameterUsageSummary.slice(0, 4).map((row) => (
                      <div key={row.diameter} className="grid grid-cols-[14px_minmax(0,1fr)_42px_68px] items-center gap-2 text-[11px]">
                        <span className="h-3 w-3 rounded-full" style={{ backgroundColor: row.color }} />
                        <span className="min-w-0 font-bold leading-tight text-[#5f5471]">{row.diameter} mm<br />bar</span>
